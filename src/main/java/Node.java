...
public class Node {
    ...
    public String[] generateNewText(String[] words,Node root){
        ...
        for(int i=0;i<words.length-1;i++){
            ...
            if(!bridge.equals("No bridge words from " + words[i] + " to " + words[i+1] + "!" )&&!bridge.equals("No word1 or word2 in the graph!")){
    ...
    static  String calculateAllShortestPath(String word1,String word2, Node[] nodeList,List<Node>path, List<List<Node>> pathList){
    ...
    public String randomWalk(String word,Node[] nodeList){
        ...
        //new txt file
        File file = new File("/home/yinzi/Documents/Vscode_docu/Intellij_docu/software_lab1/src/test/resources6.txt");
...
class  Graph{
    ...
    static void showDirectedGraph() throws IOException{
        ...
        File imgFile = new  File("/home/yinzi/Documents/Vscode_docu/Intellij_docu/software_lab1/src/test/graph2.png");
    ...
    static String calculateShortestPath(String word1, String word2, Node[] nodeList, DefaultDirectedGraph<String, DefaultEdge> graph){
        Node node1=null,node2=null;
        for(Node node : nodeList){
            if(node.name.equals(word1)){
                node1 = node;
